...
// стабилизирует fullpage  только если размер окна больше 1200_ работает fullpage
function stabilize(){
...
// slide menu
$('ul.nav__list').animate({"left": "-110%", "z-index": "0"});

$(".nav__button").click(function() {

    if($(this).attr('data-click-state') == 0) {
      $(this).attr('data-click-state', 1);
      $('ul.nav__list').animate({"left": "-110%", "z-index": "0"}, 600);
    }

    else {
      $(this).attr('data-click-state', 0);
      $('ul.nav__list').animate({"left": "0", "z-index": "500", "display": "block"}, 600);
    }
